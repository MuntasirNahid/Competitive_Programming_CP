...
Euler Cycle: when all the vertices have even degree

return true if
1)av is only adjacent vertex of v
2)there are multiple adjacents and edges v-av is not a bridge(if we remove the edge ,graph becomes disconnected)
