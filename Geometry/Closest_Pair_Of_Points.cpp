...
Brute force solution's Time complexity is O(n^2).Which is not that efficient

Most efficient technique is Divide And Conquer Technique
...
int main()
{
    ...
    cout << "The smallest dist is = " << closest(P, n);
    return 0;
}
/*
T(n) = T(n x Logn x Logn)

The smallest dist is = 1.41421
*/